...
from ui.batch_mode_page import BatchModePage
...
class Index(tk.Frame):
    ...
    def _left_panel(self, parent) -> None:
        ...
        self.page3 = BatchModePage(self.panel_left, on_message = self._update_result)
        self.notebook.add(self.page3, text="Batch Process")
